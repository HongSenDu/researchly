...
And I should see "newGroup" detail page
...
Scenario: Cannot Create new Group with no Name (Sad Path)
When I follow "New Group"
Then I should be on the new Group page
And I fill in "Description" with "A cool new group"
And I press Create
Then I should be on the new Group page
And I should see "Group must have a name" 

Scenario: Cannot Edit Group to have No Name (Sad Path)
When I follow "Group 1"
And I follow "Edit"
Then I should be on the details page for "Group 1"
And I fill in "Name" with ""
And I press "Update Group"
Then I should see "Group name required"

Scencario: Cannot  Edit Group to have No Description (Sad Path)
When I follow "Group 1"
And I follow "Edit"
Then I should be on the details page for "Group 1"
And I fill in "Description" with ""
And I press "Update Group"
Then I should see "Group description required"
